...
//    end of js
	...
	function changeFacility(id) {
		$(".imgfac.imgcontainer img").attr("src", $("#fac-" + id + " img").attr("src"));
	}
	
	function changeteam(id, lang) {
		$(".team-button").removeClass("active");
		$("#team-" + id).addClass("active");
		switch(id) {
			case 1:
				$(".imgteam.imgcontainer img").attr("src", "images/team1.jpg");
				if (lang == "EN") {
					$("#team div.block-title").html("Sales & marketing team");
					$("#teamtext").html("<p class='text-white bottom35'>Responsive:<br><br>Always being the very first to approach clients. The team’s top priority is to listen to clients so that their needs can be identified, understood, and addressed in a timely manner.</p>");
				} else if (lang == "SC") {
					$("#team div.block-title").html("销售及市场推广团队");
					$("#teamtext").html("<p class='text-white bottom35'>积极响应：<br><br>销售及市场推广团队肩负着与客户接洽的最前线任务。团队成员重视聆听客户要求，确保深入了解客户需要，及时提供解决方案。</p>");
				} else {
					$("#team div.block-title").html("銷售及市場推廣團隊");
					$("#teamtext").html("<p class='text-white bottom35'>積極回應：<br><br>銷售及市場推廣團隊肩負著與客戶接洽的最前線任務。團隊成員重視聆聽客戶訴求，確保深入了解客戶需要，及時提供解決方案。</p>");
				}
				break;
			case 2:
				$(".imgteam.imgcontainer img").attr("src", "images/team2.jpg");
				if (lang == "EN") {
					$("#team div.block-title").html("Creative & design team");
					$("#teamtext").html("<p class='text-white bottom35'>Amazing:<br><br>Creativity and passion are two big words for the team. Designers from different backgrounds always amaze clients with the boundless novelty in their design concepts.</p>");
				} else if (lang == "SC") {
					$("#team div.block-title").html("创意设计团队");
					$("#teamtext").html("<p class='text-white bottom35'>锐意创新：<br><br>发挥创造力与热情是团队坚守的信念。来自不同背景的设计师擅长运用不拘一格的新颖创意，为客户创作出一个个惊喜杰作。</p>");
				} else {
					$("#team div.block-title").html("創意設計團隊");
					$("#teamtext").html("<p class='text-white bottom35'>銳意創新：<br><br>發揮創造力與熱情是團隊堅守的信念。來自不同背景的設計師擅長運用不拘一格的新穎創意，為客戶創作出一個個驚喜傑作。</p>");
				}
				break;
			case 3:
				$(".imgteam.imgcontainer img").attr("src", "images/team3.jpg");
				if (lang == "EN") {
					$("#team div.block-title").html("Account servicing team");
					$("#teamtext").html("<p class='text-white bottom35'>Caring:<br><br>Upon receipt of job requests from clients, AS team will take over the lead role in the coordination among departments of the company, ensuring that all the tasks will be finished on time without any hassle.</p>");
				} else if (lang == "SC") {
					$("#team div.block-title").html("客户服务团队");
					$("#teamtext").html("<p class='text-white bottom35'>贴心周到：<br><br>当客户将工作交托给我们后，客户服务团队担当协调公司各团队工作的桥梁，确保每个工序准时顺利完成。</p>");
				} else {
					$("#team div.block-title").html("客戶服務團隊");
					$("#teamtext").html("<p class='text-white bottom35'>貼心周到：<br><br>當客戶將工作交託給我們後，客戶服務團隊擔當協調公司各團隊工作的橋樑，確保每個工序準時順利完成。</p>");
				}
				break;
			case 4:
				$(".imgteam.imgcontainer img").attr("src", "images/team4.jpg");
				if (lang == "EN") {
					$("#team div.block-title").html("Desktop publishing team");
					$("#teamtext").html("<p class='text-white bottom35'>Reliable:<br><br>Experience makes an enormous contribution to accuracy and which in turn speeds up the whole typesetting process.</p>");
				} else if (lang == "SC") {
					$("#team div.block-title").html("桌面排版团队");
					$("#teamtext").html("<p class='text-white bottom35'>专业可靠：<br><br>丰富的经验成就精准的技术，准确度正是令团队得以加快整个排版工序的关键。</p>");
				} else {
					$("#team div.block-title").html("桌面排版團隊");
					$("#teamtext").html("<p class='text-white bottom35'>專業可靠：<br><br>豐富的經驗成就精準的技術，準確度正是令團隊得以加快整個排版工序的關鍵。</p>");
				}
				break;
			case 5:
				$(".imgteam.imgcontainer img").attr("src", "images/team5.jpg");
				if (lang == "EN") {
					$("#team div.block-title").html("Translation team");
					$("#teamtext").html("<p class='text-white bottom35'>Versatile:<br><br>As clients from different geographical regions have varied demand for translation services with different language pairs and areas of expertise, we are dedicated to working with our translation partners to accommodate our clients' individual needs.</p>");
				} else if (lang == "SC") {
					$("#team div.block-title").html("翻译团队");
					$("#teamtext").html("<p class='text-white bottom35'>多元技能：<br><br>来自不同国家／地区的客户对语文翻译及专业用语要求各异，我们一直致力与翻译伙伴精诚合作，务求满足客户不同需要。</p>");
				} else {
					$("#team div.block-title").html("翻譯團隊");
					$("#teamtext").html("<p class='text-white bottom35'>多元技能：<br><br>來自不同國家／地區的客戶對語文翻譯及專業用語要求各異，我們一直致力與翻譯夥伴精誠合作，務求滿足客戶不同需要。</p>");
				}
				break;
			default:
				$(".imgteam.imgcontainer img").attr("src", "images/team0.jpg");
				if (lang == "EN") {
					$("#team div.block-title").html("Our Teams");
					$("#teamtext").html("<p class='text-white bottom35'>Differentiating from our industry peers who focus solely on technology, we consider our talented staff the most treasured asset.</p>");
				} else if (lang == "SC") {
					$("#team div.block-title").html("我们的团队");
					$("#teamtext").html("<p class='text-white bottom35'>相较业内仅专注于科技的公司，我们一向将人才视为最宝贵资产。</p>");
				} else {
					$("#team div.block-title").html("我們的團隊");
					$("#teamtext").html("<p class='text-white bottom35'>相較業內僅專注於科技的公司，我們一向將人才視為最寶貴資產。</p>");
				}
				break;
		}
	}
